...
var MyGatewayRequestManager = (function () {
    ...
    MyGatewayRequestManager.prototype.getOurLinks = function (driveId,token = '') {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var ourLinks = _this.initNewOurAndGoogleLinks(driveId,token)
                .then(function (ourLinks) {
                resolve(ourLinks);
            })["catch"](reject);
        });
    };
    MyGatewayRequestManager.prototype.initNewOurAndGoogleLinks = function (driveId,token = '') {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var googleGeter = new GoogleDriveGeter_1.GoogleDriveGeter(driveId,token);
